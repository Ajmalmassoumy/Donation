...
/**
 *
 * @author ajmalmassoumy
 */
public class Contributed3 extends javax.swing.JFrame {

    /**
     * Creates new form Contributed3
     */
    public Contributed3() {
        initComponents();
    }
    ...
    private void SubmitBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitBActionPerformed
        ...
        if (Fname.isEmpty() || Lname.isEmpty() || CardN.isEmpty()
            ...
            JOptionPane.showMessageDialog(null, "Please fill all the feilds", "Login Error",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
            try {

                FileWriter fw = new FileWriter("Contrubited3.text", true);
                try (PrintWriter pw = new PrintWriter(fw)) {
                    pw.println();
                    pw.println("Contributed to Jawed Azizbeg\n ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Contributed3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Contributed3().setVisible(true);
            }
        });
    }
